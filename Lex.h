...
enum type_of_lex {
    ...
    LEX_FIN, LEX_SEMICOLON, LEX_COMMA, LEX_UN_MINUS, LEX_ASSIGN, LEX_LPAREN, LEX_RPAREN, LEX_EQ,
    LEX_LSS, LEX_GTR, LEX_PLUS, LEX_MINUS, LEX_TIMES, LEX_SLASH, LEX_LEQ, LEX_NEQ, LEX_GEQ,
    LEX_NUM, LEX_STRC, LEX_ID, POLIZ_LABEL, POLIZ_ADDRESS, POLIZ_GO, POLIZ_FGO, LEX_UN_PLUS
};
